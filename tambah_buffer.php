    ...
    if (create_buffer($_POST) > 0) {
        echo "<script src='assets_template/plugins/jquery/jquery.min.js'></script>
              ...
              <script>
                Swal.fire({
                    title: 'Berhasil',
                    text: 'Data buffer Berhasil Ditambahkan',
                    icon: 'success',
        ...
        echo "<script src='assets_template/plugins/jquery/jquery.min.js'></script>
              ...
              <script>
                Swal.fire({
                    title: 'Gagal',
                    text: 'Data buffer Gagal Ditambahkan',
                    icon: 'error',
                    confirmButtonText: 'OK'
                }).then(() => {
                    window.location.href = 'buffer.php';
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Data Buffer</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Tambah Data Buffer</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
