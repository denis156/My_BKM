                    ...
                    <?php endif; ?>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="mt-3 ml-3">
                                    <a href="tambah_delivery.php" class="btn btn-primary d-inline-block ml-1"><i class="fas fa-plus-circle"></i> Tambah</a><?php 
                                    if ($_SESSION['level'] == 'admin') : ?>
                                    <a href="download_excel_delivery.php" class="btn btn-success d-inline-block"><i class="far fa-file-excel"></i> Excel</a>
                                    <?php endif; ?>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td width="10%" class="text-center">
                                                    <a href="ubah_delivery.php?id_delivery=<?= $delivery['id_delivery']; ?>"class="btn btn-block bg-gradient-success btn-sm"><i class="fas fa-edit"></i> Ubah</a>
                                                    <a href="javascript:void(0);"class="btn btn-block bg-gradient-danger btn-sm"onclick="confirmDelete(<?= $delivery['id_delivery']; ?>)"><i class="fas fa-trash-alt"></i> Hapus</a>
                                                </td>
                                                <?php endif; ?>
                                            </tr>
                                            <?php endforeach; ?>
...
<script>
    function confirmDelete(id_delivery) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = 'hapus_delivery.php?id_delivery=' + id_delivery;
            }
        });
    }
</script>
