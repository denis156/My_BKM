    ...
    if (create_outside($_POST) > 0) {
        echo "<script src='assets_template/plugins/jquery/jquery.min.js'></script>
              ...
              <script>
                Swal.fire({
                    title: 'Berhasil',
                    text: 'Data outside Berhasil Ditambahkan',
                    icon: 'success',
        ...
        echo "<script src='assets_template/plugins/jquery/jquery.min.js'></script>
              ...
              <script>
                Swal.fire({
                    title: 'Gagal',
                    text: 'Data outside Gagal Ditambahkan',
                    icon: 'error',
                    confirmButtonText: 'OK'
                }).then(() => {
                    window.location.href = 'outside.php';
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Data outside</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                        <li class="breadcrumb-item active">Tambah Data outside</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card">
                        ...
                        <form action="" method="post">
                                ...
                                <div class="mb-3">
                                        ...
                                        <input type="text" id="no_segel" name="no_segel" class="form-control" placeholder="NO SEGEL"required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" select id="status" name="status" aria-label="status"required>
